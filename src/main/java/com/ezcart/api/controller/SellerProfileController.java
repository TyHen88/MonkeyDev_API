...
import com.ezcart.api.service.seller.SellerProfileService;
...
public class SellerProfileController extends BaseApiRestController {
    ...
    public ResponseEntity<ApiResponse<Object>> createSellerProfile(@Valid @RequestBody SellerProfileRequestDto requestDto) {
    ...
    public ResponseEntity<ApiResponse<Object>> getSellerProfileById(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiResponse<Object>> getSellerProfileByUserId(@PathVariable Long userId) {
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<Object>> getMySellerProfile() {
        Long userId = AuthHelper.getUserId();
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<Object>> updateSellerProfile(@Valid @RequestBody SellerProfileUpdateRequestDto requestDto) {
        Long userId = AuthHelper.getUserId();
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<ApiResponse<Object>> deleteSellerProfile() {
        Long userId = AuthHelper.getUserId();
    ...
    public ResponseEntity<ApiResponse<Object>> getAllSellerProfiles(
...
//    }
    ...
    public ResponseEntity<ApiResponse<Object>> verifySeller(@PathVariable Long id) {
    ...
    @PreAuthorize("hasAuthority('ADMIN_MANAGE')")
    public ResponseEntity<ApiResponse<Object>> updateSellerRating(
    ...
    @PreAuthorize("hasAuthority('ADMIN_MANAGE')")
    public ResponseEntity<ApiResponse<Object>> incrementSellerSales(@PathVariable Long id) {
